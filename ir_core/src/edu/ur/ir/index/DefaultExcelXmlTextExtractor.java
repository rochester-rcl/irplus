...
public class DefaultExcelXmlTextExtractor implements FileTextExtractor{
	...
	/**  Logger  */
	private static final Logger log = LogManager.getLogger(DefaultExcelXmlTextExtractor.class);
	 ...
	 * Default constructor
	 */
	public DefaultExcelXmlTextExtractor()
	{
		acceptableFileTypeExtensions.add("xlsx");
	}

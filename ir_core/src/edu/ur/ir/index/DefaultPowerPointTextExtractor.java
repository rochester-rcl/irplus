...
/**
 * Extractor for power point 97-2003.  This does not work for power point
 * 07.
 * 
 * @author Nathan Sarr
 *
 */
public class DefaultPowerPointTextExtractor implements FileTextExtractor{
	
	/** Extensions this extractor can extract text for. */
	private Set<String> acceptableFileTypeExtensions = new HashSet<String>();
	
	/**  Logger */
	private static final Logger log = LogManager.getLogger(DefaultPowerPointTextExtractor.class);
	 ...
	 * Default constructor
	 */
	public DefaultPowerPointTextExtractor()
	{
		acceptableFileTypeExtensions.add("ppt");
	}

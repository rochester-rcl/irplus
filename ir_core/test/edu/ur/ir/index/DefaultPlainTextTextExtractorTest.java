...
public class DefaultPlainTextTextExtractorTest {
	 ...
	 */
	public void testIndexPlainTextDocument() throws LocationAlreadyExistsException, IllegalFileSystemNameException
	{
        ...
        assert documentCreator.canExtractText(info.getExtension()) :
        	"Cannot create document for extension " + info.getExtension();
        ...
        try {
        	...
        	assert hits == 1 :  "Hit count should equal 1 but equals " 
    			+ hits;

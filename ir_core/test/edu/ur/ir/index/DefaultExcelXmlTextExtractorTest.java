...
public class DefaultExcelXmlTextExtractorTest {
	 ...
	 */
	public void testIndexExcelXmlDocument() throws LocationAlreadyExistsException {
		...
		String excelXmlFile = properties.getProperty("excel_xml_file");
		File f1 = new File(baseLocation + excelXmlFile);
		...
		FileTextExtractor documentCreator = new DefaultExcelXmlTextExtractor();

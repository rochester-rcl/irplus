...
<html>
    <head>
        <title>Contributor not found</title>
    ...
    <body class="yui-skin-sam">
        ...
        <div id="doc2">  
            ...
            <div id="bd">
               ...
               <p>The contributor could not be found if you think this is an error please <a href="<c:url value="/contactUs.action" />">contact us</a> with the information below</p>
   
               <h3>Person Name Id: ${personNameId}</h3>
            </div>
            <!--  end the body tag --> 

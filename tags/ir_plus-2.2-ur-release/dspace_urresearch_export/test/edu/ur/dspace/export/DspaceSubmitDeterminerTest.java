...
public class DspaceSubmitDeterminerTest {
	
	
	/** get the application context */
	ApplicationContext ctx = ContextHolder.getApplicationContext();
	
	DspaceSubmitDeterminer dspaceSubmitDeterminer = (DspaceSubmitDeterminer)ctx.getBean("dspaceSubmitDeterminer");
	...
	public void testIsAdmin()
	{
		...
		{
			if( dspaceSubmitDeterminer.canSubmit(u))
			{
			    System.out.println("User = " + u + " can SUBMIT!");
			}
		}
	}

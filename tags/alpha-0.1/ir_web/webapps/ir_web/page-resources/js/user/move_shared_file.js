...
/**
 * This code is for dealing with moving shared files 
 * to the workspace.
 */
YAHOO.namespace("ur.shared.file.move");


YAHOO.ur.shared.file.move = 
{
    getMoveFolder : function(destinationId)
    {
        var viewMoveSharedFilesAction = basePath + 'user/getMoveSharedFilesDestinations.action';
        document.getElementById("destination_id").value = destinationId;
        document.viewChildContentsForMove.action = viewMoveSharedFilesAction;
	    ...
	    var handleSuccess = function(o) 
	    {
	        ...
	        {       	    
	            ...
	            document.getElementById('move_shared_file_frag').innerHTML = response;
	        }
	    };
        ...
        YAHOO.util.Connect.asyncRequest('POST', viewMoveSharedFilesAction,
    ...
    moveFile : function()
    {
	    ...
	    var handleSuccess = function(o) 
	    {
	        ...
	        {       	    
	            ...
	            if( success != 'true' )
	            {
	                ...
	                YAHOO.ur.shared.file.move.moveErrorDialog.center();
	                YAHOO.ur.shared.file.move.moveErrorDialog.show();
 	            }
	            else
	            {
	    ...
	    YAHOO.util.Connect.setForm('viewChildContentsForMove');
        var action = basePath + "user/moveSharedFileInformation.action";
    ...
    createMoveErrorDialog : function()
    {
	    ...
	    YAHOO.ur.shared.file.move.moveErrorDialog = 
	    ...
	    YAHOO.ur.shared.file.move.moveErrorDialog.setHeader("Error");
	
	    // Render the Dialog
	    YAHOO.ur.shared.file.move.moveErrorDialog.render();
    }, 
    
    init : function()
    {
        YAHOO.ur.shared.file.move.createMoveErrorDialog();
    }
...
YAHOO.util.Event.onDOMReady(YAHOO.ur.shared.file.move.init);
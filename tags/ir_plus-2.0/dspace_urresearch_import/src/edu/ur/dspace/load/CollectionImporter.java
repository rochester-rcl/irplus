...
/**
 * Interface for importing dspace collections into urresearch.
 * 
 * @author Nathan Sarr
 *
 */
public interface CollectionImporter {
	 ...
	 */
	public void ImportCollections(String zipfile, Repository repository) throws IOException, DuplicateNameException, IllegalFileSystemNameException  ;
	 ...
	 * @throws IOException
	 */
	public List<DspaceCollection> getCollections(File zipFile) throws IOException;

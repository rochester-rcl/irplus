...
public class UrFileUpload extends AbstractInterceptor {

    private static final long serialVersionUID = -4764627478894962478L;

    protected static final Logger LOG = LogManager.getLogger(UrFileUpload.class);
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        Enumeration<String> otherParamNames = multiWrapper.getParameterNames();
        Map<String, Parameter> otherParams = new HashMap<>();
        while(otherParamNames != null && otherParamNames.hasMoreElements()) {
        	LOG.debug("other param names = " + otherParamNames.nextElement());
        }

 ...
 */
YAHOO.namespace("ur.project_page.filesystem.move");


YAHOO.ur.project_page.filesystem.move = 
{
	/**
    ...
    {
        var viewMoveFoldersAction = basePath + 'user/getMoveGroupWorkspaceProjectPageFolderDestinations.action';

...
<html>
    <head>
        <title>Group workspace not found</title>
    ...
    <body class="yui-skin-sam">
        ...
        <div id="doc2">  
            ...
            <div id="bd">
               <h3>Group Workspace Not Found</h3> 
               
               <p>The group workspace could not be found if you think this is an error please <a href="<c:url value="/contactUs.action" />">contact us</a> with the information below</p>
   
               <h3>Group workspace Id: ${groupWorkspaceId}</h3>
            </div>
            <!--  end the body tag --> 

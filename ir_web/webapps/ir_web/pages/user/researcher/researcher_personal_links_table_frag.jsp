...
<c:set var="linkSize" value="${ur:collectionSize(researcher.personalLinks)}"/>
<div class="dataTable">
<urstb:table width="100%">
    ...
    <urstb:tbody
           ...
           oddRowClass="odd"
                ...
                rowStatus="rowStatus"
                collection="${researcher.personalLinks}">
                    <urstb:tr 
                        cssClass="${rowClass}"
                        ...
                        <urstb:td>
                             <a href="javascript:YAHOO.ur.researcher.link.editLink('${link.researcher.id}', '${link.id}');">${link.name}</a>
                        </urstb:td>
                        <urstb:td>
                            ${link.url}  
                        </urstb:td>
                        ...
                        <urstb:td>
                             <img class="tableImg" alt="" 
                                 src="${pageContext.request.contextPath}/page-resources/images/all-images/delete.gif"/>  <a href="javascript:YAHOO.ur.researcher.link.removeLink('${link.name}');"> Remove </a>
                        </urstb:td>

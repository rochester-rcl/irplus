...
<html>
    <head>
        ...
        <!--  base path information -->
 	    <ur:js src="${pageContext.request.contextPath}/page-resources/images/help-images/admin/${pageContext.request.contextPath}/page-resources/images/help-images/admin/page-resources/images/help-images/user/page-resources/js/util/base_path.jsp"/>

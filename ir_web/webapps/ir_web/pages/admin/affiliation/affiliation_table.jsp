...
<div class="dataTable">
	<ur:basicForm method="post" id="affiliations" name="myAffiliations" >
	             
	    <urstb:table width="100%">
	        <urstb:thead>
	            <urstb:tr>
					<urstb:td><ur:checkbox name="checkAllSetting" 
								value="off" onClick="YAHOO.ur.affiliation.setCheckboxes();"/></urstb:td>         
	                <urstb:td>Id</urstb:td>
             
	                <urstb:tdHeadSort  height="33"
	                    currentSortAction="${sortType}"
	                    ascendingSortAction="javascript:YAHOO.ur.affiliation.getAffiliations(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'asc');"
	            ...
	            <urstb:tbody
	                ...
	                collection="${affiliations}">
	                    <urstb:tr 
	                        ...
	                        <urstb:td>
		                        <ur:checkbox name="affiliationIds" value="${affiliation.id}"/>
	                        </urstb:td>
	                        <urstb:td>
		                        ${affiliation.id}
	                        </urstb:td>

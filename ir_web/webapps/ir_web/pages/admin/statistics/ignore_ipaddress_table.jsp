...
<div class="dataTable">
	<ur:basicForm method="post" id="ignoreIpAddresses" name="myIgnoreIpAddresses" >
	             
	    <urstb:table width="100%">
	        <urstb:thead>
	            <urstb:tr>
					<urstb:td><ur:checkbox name="checkAllSetting" 
								value="off" onClick="YAHOO.ur.ignore.ipaddress.setCheckboxes();"/></urstb:td>         
	            ...
	            <urstb:tbody
	                ...
	                collection="${ignoreIpAddresses}">
	                    <urstb:tr 
	                        cssClass="${rowClass}"
	                        onMouseOver="this.className='highlight'"
	                        onMouseOut="this.className='${rowClass}'">
	                        <urstb:td>
		                        <ur:checkbox name="ignoreIpAddressIds" value="${ignoreIpAddress.id}"/>
	                        </urstb:td>
	                        <urstb:td>
		                        ${ignoreIpAddress.id}
	                        </urstb:td>

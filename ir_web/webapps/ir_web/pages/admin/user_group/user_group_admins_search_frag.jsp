...
<c:import url="user_group_admin_search_pager.jsp"/>
            ...
            <urstb:tbody
                ...
                <urstb:tr 
                    ...
                    onMouseOut="this.className='${rowClass}'">
                        <c:if test="${!ir:isAdminOfGroup(user,userGroup)}">
                        <urstb:td><a href="javascript:YAHOO.ur.usergroup.edit.addAdmin(${user.id}, ${userGroup.id});">Add User</a></urstb:td>
                        </c:if>
                        <c:if test="${ir:isAdminOfGroup(user,userGroup)}">
                        <urstb:td><a href="javascript:YAHOO.ur.usergroup.edit.removeAdmin(${user.id}, ${userGroup.id});">Remove User</a></urstb:td>
                        </c:if>

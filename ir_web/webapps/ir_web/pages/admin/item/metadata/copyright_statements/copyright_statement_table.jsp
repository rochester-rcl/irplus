...
<div class="dataTable">
	<ur:basicForm method="post" id="copyrightStatements" name="myCopyrightStatements" >
	        ...
	        <urstb:thead>
	            <urstb:tr>
	                ...
	                <urstb:tdHeadSort  height="33"
	                    ...
	                    ascendingSortAction="javascript:YAHOO.ur.copyright.statement.getContributorTypes(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'asc');"
	            ...
	            <urstb:tbody
	                ...
	                collection="${copyrightStatements}">
	                    <urstb:tr 
	                        cssClass="${rowClass}"
	                        onMouseOver="this.className='highlight'"
	                        onMouseOut="this.className='${rowClass}'">
	                        <urstb:td>
		                        ${copyrightStatement.id}
	                        </urstb:td>
	                        <urstb:td>
	                        ...
	                        <urstb:td>
	                           ${copyrightStatement.description}
	                        </urstb:td>
	                        <urstb:td>
	                             <a href="javascript:YAHOO.ur.copyright.statement.editCopyrightStatement(${copyrightStatement.id});">Edit</a> / <a href="javascript:YAHOO.ur.copyright.statement.deleteCopyright(${copyrightStatement.id});">Delete</a>
	                        </urstb:td>
	                    </urstb:tr>
	            </urstb:tbody>
	        </urstb:table>

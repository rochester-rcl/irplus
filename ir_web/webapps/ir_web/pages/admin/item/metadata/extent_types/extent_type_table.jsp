...
<div class="dataTable">
	<ur:basicForm method="post" id="extentTypes" name="myExtentTypes" >
	             
	    <urstb:table width="100%">
	        <urstb:thead>
	            <urstb:tr>
					<urstb:td><ur:checkbox name="checkAllSetting" 
								value="off" onClick="YAHOO.ur.extent.type.setCheckboxes();"/></urstb:td>         
	                <urstb:td>Id</urstb:td>
             
	                <urstb:tdHeadSort  height="33"
	                    currentSortAction="${sortType}"
	                    ascendingSortAction="javascript:YAHOO.ur.extent.type.getExtentTypes(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'asc');"
	            ...
	            <urstb:tbody
	                ...
	                collection="${extentTypes}">
	                    <urstb:tr 
	                        cssClass="${rowClass}"
	                        onMouseOver="this.className='highlight'"
	                        onMouseOut="this.className='${rowClass}'">
	                        <urstb:td>
		                        <ur:checkbox name="extentTypeIds" value="${extentType.id}"/>
	                        </urstb:td>
	                        <urstb:td>
		                        ${extentType.id}
	                        </urstb:td>

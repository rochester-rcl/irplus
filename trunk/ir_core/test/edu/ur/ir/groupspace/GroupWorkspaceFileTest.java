...
public class GroupWorkspaceFileTest {
	...
	public void basicGroupFileTest() throws DuplicateNameException, IllegalFileSystemNameException, LocationAlreadyExistsException
	{
		...
		GroupWorkspaceFolder groupFolder = groupSpace.createRootFolder(user, "testFolder");
		GroupWorkspaceFile groupFile = new GroupWorkspaceFile(vif, groupFolder);

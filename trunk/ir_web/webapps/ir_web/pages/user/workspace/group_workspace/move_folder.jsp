...
<head>
    ...
    <ur:js src="page-resources/js/user/move_group_workspace_info.js" />
...
<body class="yui-skin-sam">
    ...
    <div id="doc2"><!--  this is the header of the page --> 
        ...
        <h3>Move Group Workspace Folders and Files</h3>
        <!--  this is the body regin of the page -->
        <div id="bd">
            <c:url var="cancelUrl" value="/user/workspace.action">
                <c:param name="tabName" value="GROUP_WORKSPACE"/>
                <c:param name="groupWorkspaceId" value="${groupWorkspaceId}"/>
                <c:param name="groupWorkspaceFolderId" value="${parentFolderId}"/>
            </c:url>
               ...
               <tr>
		           ...
		           <td width="400px" align="left" valign="top">
		               <div id="destination_path">
		                   Move To Location: /<a href="javascript:YAHOO.ur.group_workspace.move.getMoveFolder('0');">${groupWorkspace.name}</a>/
		   ...
		   <td width="400px" align="left" valign="top">
		       <form name="viewChildContentsForMove" id="move_folder_form">
	              ...
	              <input type="hidden" id="groupWorkspaceId" name="groupWorkspaceId" value="${groupWorkspaceId}" /> 
	
	               <c:forEach items="${foldersToMove}" var="folder">
	                   <input type="hidden" value="${folder.id}" name="groupFolderIds" />
                   </c:forEach> 
 
                   <c:forEach items="${filesToMove}" var="file">
	                   <input type="hidden" value="${file.id}" name="groupFileIds" />
                   </c:forEach>

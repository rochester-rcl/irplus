...
<c:if test="${totalHits > 0}">
	...
	<c:import url="browse_all_user_groups_pager.jsp"/>
</c:if>

<div class="dataTable">
	<ur:basicForm method="post" id="userGroups" name="myUserGroups" >
	             
	    <urstb:table width="100%">
	        <urstb:thead>
	            <urstb:tr>
					<urstb:td><ur:checkbox name="checkAllSetting" 
								value="off" onClick="YAHOO.ur.usergroup.setCheckboxes();"/></urstb:td>         
	                <urstb:td>Id</urstb:td>
             
	                <urstb:tdHeadSort  height="33"
	                    currentSortAction="${sortType}"
	                    ascendingSortAction="javascript:YAHOO.ur.usergroup.getUserGroups(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'asc');"
	                    descendingSortAction="javascript:YAHOO.ur.usergroup.getUserGroups(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'desc');">
	                    <u>Name</u>                                              
	                    <urstb:thImgSort
	            ...
	            <urstb:tbody
	                ...
	                collection="${userGroups}">
	                    <urstb:tr 
	                        ...
	                        <urstb:td>
		                        <ur:checkbox name="userGroupIds" value="${userGroup.id}"/>
	                        </urstb:td>
	                        <urstb:td>
		                        ${userGroup.id}
	                        </urstb:td>

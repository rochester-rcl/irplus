...
<c:if test="${totalHits > 0}">
	...
	<c:import url="browse_all_sponsors_pager.jsp"/>
	<br/>
</c:if>

<div class="dataTable">
	<ur:basicForm method="post" id="sponsors" name="mySponsors" >
	             
	    <urstb:table width="100%">
	        <urstb:thead>
	            <urstb:tr>
					<urstb:td><ur:checkbox name="checkAllSetting" 
								value="off" onClick="YAHOO.ur.sponsor.setCheckboxes();"/></urstb:td>         
	                <urstb:td>Id</urstb:td>
             
	                <urstb:tdHeadSort  height="33"
	                    currentSortAction="${sortType}"
	                    ascendingSortAction="javascript:YAHOO.ur.sponsor.getSponsors(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'asc');"
	                    descendingSortAction="javascript:YAHOO.ur.sponsor.getSponsors(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'desc');">
	                    <u>Name</u>                                              
	                    <urstb:thImgSort
	            ...
	            <urstb:tbody
	                ...
	                collection="${sponsors}">
	                    <urstb:tr 
	                        ...
	                        <urstb:td>
		                        <ur:checkbox name="sponsorIds" value="${sponsor.id}"/>
	                        </urstb:td>
	                        <urstb:td>
		                        ${sponsor.id}
	                        </urstb:td>

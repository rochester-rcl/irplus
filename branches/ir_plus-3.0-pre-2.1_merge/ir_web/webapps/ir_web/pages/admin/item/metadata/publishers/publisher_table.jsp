...
<c:if test="${totalHits > 0}">
	...
	<c:import url="browse_all_publishers_pager.jsp"/>
	<br/>
</c:if>
...
<div class="dataTable">
	<ur:basicForm method="post" id="publishers" name="myPublishers" >
	             
	    <urstb:table width="100%">
	        <urstb:thead>
	            <urstb:tr>
					<urstb:td><ur:checkbox name="checkAllSetting" 
								value="off" onClick="YAHOO.ur.publisher.setCheckboxes();"/></urstb:td>         
	                <urstb:td>Id</urstb:td>
             
	                <urstb:tdHeadSort  height="33"
	                    currentSortAction="${sortType}"
	                    ascendingSortAction="javascript:YAHOO.ur.publisher.getPublishers(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'asc');"
	                    descendingSortAction="javascript:YAHOO.ur.publisher.getPublishers(${rowStart}, ${startPageNumber}, ${currentPageNumber}, 'desc');">
	                    <u>Name</u>                                              
	                    <urstb:thImgSort
	            ...
	            <urstb:tbody
	                ...
	                collection="${publishers}">
	                    <urstb:tr 
	                        ...
	                        <urstb:td>
		                        <ur:checkbox name="publisherIds" value="${publisher.id}"/>
	                        </urstb:td>
	                        <urstb:td>
		                        ${publisher.id}
	                        </urstb:td>

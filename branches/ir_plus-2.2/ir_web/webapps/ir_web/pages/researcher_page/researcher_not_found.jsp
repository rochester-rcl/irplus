...
<html>
    <head>
        <title>Researcher Page Not Found</title>
    ...
    <body class="yui-skin-sam">
        ...
        <div id="doc2">  
            ...
            <div id="bd">
               <h3>We're sorry the researcher page could not be found or has been removed.  Please check the URL and make sure it is correct. <a href="<c:url value="/contactUs.action"/>">Contact Us</a> if you feel this is an error.</h3> 

...
DROP TABLE person.person_name_authority_identifier;
DROP TABLE person.person_name_authority;
DROP TABLE person.person_name_authority_identifier_type;
...
DROP SEQUENCE person.person_name_authority_identifier_seq;
DROP SEQUENCE person.person_name_authority_seq;
DROP SEQUENCE person.person_name_authority_identifier_type_seq;
